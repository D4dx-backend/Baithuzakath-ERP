...
import { Download, Eye, CheckCircle, XCircle, FileText, Loader2 } from "lucide-react";
...
export default function FieldVerificationApplications() {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Field Verification Applications</h1>
      ...
      <Card>
        <CardHeader><CardTitle>Field Verification Applications ({pagination.total})</CardTitle></CardHeader>
        <CardContent>
          {loading ? (
            ...
            <p className="text-muted-foreground text-center py-8">No applications pending field verification</p>
          ) : (
